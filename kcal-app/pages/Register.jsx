  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password2: Yup.string()
        ...
        .required("To pole nie może być puste"),
      weight: Yup.number().required("To pole nie może być puste"),
      height: Yup.number().required("To pole nie może być puste"),
    }),
    onSubmit: (values) => {
    ...
    <div className="flex flex-col gap-4  px-6 py-2 ">
      <div className="flex flex-col bg-white rounded-xl box-shadow p-12  gap-4 items-center ">
        ...
        <form
          ...
          className="flex flex-col gap-6 min-w-[584px]"
        >
          <TextField
            id="email"
          ...
          <TextField
            ...
            type="password"
            variant="outlined"
            error={formik.errors.password ? true : null}
          ...
          <TextField
            ...
            type="password"
            variant="outlined"
            error={formik.errors.password2 ? true : null}
          ...
          <TextField
            ...
            variant="outlined"
            error={formik.errors.weight ? true : null}
